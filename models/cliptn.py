...
class CLIPDensePredT(CLIPDenseBase):
    ...
    def __init__(self, version='ViT-B/16', extract_layers=(3, 6, 9), cond_layer=0, reduce_dim=64, n_heads=4,
                 prompt='fixed',
...
class CLIPTNseg(CLIPDensePredT):
    def __init__(self, size=352,version='ViT-B/16', extract_layers=(3, 6, 9), cond_layer=0, reduce_dim=64, n_heads=4,
                 prompt='fixed',
                 extra_blocks=0, reduce_cond=None, fix_shift=False,
                 learn_trans_conv_only=False, limit_to_clip_only=False, upsample=False,
                 add_calibration=False, rev_activations=False, trans_conv=None, n_tokens=None,
    ...
    def forward(self, inp_image, conditional=None, return_features=False, mask=None):
        # x1, visual_q, cond, acts = self.CLIPB(inp_image, conditional , return_features, mask)
        x1 = self.CLIPB(inp_image, conditional , return_features, mask)
        x2 = self.URB(inp_image)
